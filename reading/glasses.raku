...
# make a new readingclub repo c̄ eupl @radical, but maybe call it reading.den (https://youtu.be/xfQM4cRXho8?t=13m37s) instead, or even reading.lib #tla #promptengineeringupskills
 ...
 # so the website will have prompt(reading den, cosy, pretty girls with lovely long hair curled up reading a book with a massive mug of tea next to them, oversized, chai, traffic out the window iff there is a window, imagination bleeding out of the pages versus i know kung fu versus whatnot,..)
